...
<head>
    ...
    <link rel="stylesheet" href="styles_for_admin.css">
</head>
<body>
    <h1>Admin Panel</h1>
    ...
    <form action="add_platform.php" method="POST" enctype="multipart/form-data">
    ...
    <table>
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>
                <form action='edit_game.php' method='GET' style='display: inline-block;'>
                    <input type='hidden' name='game_id' value='" . $row['id'] . "'>
    ...
    <table>
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>
                <form action='edit_category.php' method='GET' style='display: inline-block;'>
                    <input type='hidden' name='category_id' value='" . $row['id'] . "'>
                    <button type='submit'>Edit</button>
                </form>
            </td>";
    ...
    <table>
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td>" . htmlspecialchars($row['name']) . "</td>";
            echo "<td>
                <form action='delete_platform.php' method='POST'>
            ...
            echo "<td>
                <form action='edit_platform.php' method='GET' style='display: inline-block;'>
                    <input type='hidden' name='platform_id' value='" . $row['id'] . "'>
                    <button type='submit'>Edit</button>
                </form>
            </td>";
