...
<head>
    ...
    <link rel="stylesheet" href="../styles/styles_for_game.css">
...
<body>
    ...
    <div class="container">
        <?php if (isset($game)): ?>
            ...
            <div class="actions">
                <form action="../util/cart.php" method="POST" style="display:inline;">
                    <input type="hidden" name="game_id" value="<?= $game_id ?>">
                    <button type="submit" class="button">Add to Cart</button>
                </form>

                <a href="../util/buy.php?id=<?= $game_id ?>" class="button">Buy</a>
            </div>
