...
<head>
    ...
    <link rel="stylesheet" href="styles_for_profile.css">
</head>
<body>
    <h2>Profile tabs:</h2>
    <ul>
        <li><a href="profile.php">Orders</a></li>
        <li><a href="contact_and_address.php">Contact and Address Information</a></li>
    </ul>
            ...
            <tbody>
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td><a href="order_details.php?order_id=<?= $order['id'] ?>">View details</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
