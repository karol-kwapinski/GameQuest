...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_contact_address'])) {
    ...
    header("Location: contact_and_address_page.php");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="../styles/styles_for_contact_and_address.css">
</head>
<body>
        ...
        <ul>
            <?php while ($row = $contacts_result->fetch_assoc()): ?>
                <li>
                    ...
                    <a href="contact_and_address_page.php?delete_id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete these details?')">Delete</a>
                    <a href="contact_and_address_page.php?set_default=<?= $row['id'] ?>">Set as Default</a>
                </li>
            <?php endwhile; ?>
        </ul>
    <?php else: ?>
    ...
    <form method="POST" action="contact_and_address_page.php" onsubmit="return validateForm()">
